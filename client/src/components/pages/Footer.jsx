...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-linear-to-b from-green-50 to-emerald-100 border-t border-green-200">
      <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-green-500 via-emerald-500 to-green-600"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {socialLinks.map((social, idx) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-green-200 flex items-center justify-center hover:bg-linear-to-br hover:from-green-500 hover:to-emerald-600 text-gray-600 hover:text-white transition-all duration-300 hover:scale-110"
                  >
        ...
        <div className="py-8 border-t border-green-200">
        ...
        <div className="py-6 border-t border-green-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={scrollToTop}
                className="w-10 h-10 rounded-full bg-linear-to-br from-green-500 to-emerald-600 text-white flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg"
